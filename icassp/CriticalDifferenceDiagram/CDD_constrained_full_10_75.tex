...
\draw[treatment line] ([yshift=-2pt] axis cs:1.70484375, 0) |- (axis cs:1.45484375, -2.5)
  node[treatment label, anchor=west] {conv-MMP};
\draw[treatment line] ([yshift=-2pt] axis cs:1.9528125, 0) |- (axis cs:2.59234375, -3.0)
  node[treatment label, anchor=east] {conv-OMP};
\draw[treatment line] ([yshift=-2pt] axis cs:2.34234375, 0) |- (axis cs:2.59234375, -2.0)
